...
export function LoginPage({ navigate }) {
  ...
  return (
    <main className="login-page">
      <section className="login-image-panel" aria-label="DocLens login illustration" />
      <section className="login-form-panel">
        ...
        <form className="login-card" onSubmit={(e) => e.preventDefault()}>
          ...
          <button type="button" className="login-submit" disabled={loading} onClick={handleSignIn}>
